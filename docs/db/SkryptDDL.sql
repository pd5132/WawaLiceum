...
CREATE TABLE dbo.Wymiar_Szkola (
    ...
    url_instagram varchar(255) NULL,
...
CREATE TABLE dbo.Wymiar_Atmosfera (
    ...
    czy_strefa_ciszy bit NOT NULL,
    czy_miejsce_odpoczynku bit NOT NULL,
    czy_ciche_dzwonki bit NOT NULL,
    czy_rozowa_skrzyneczka bit NOT NULL,
    czy_szafki_uczniow bit NOT NULL,
    czy_stojak_na_rowery bit NOT NULL,
    czy_teren_zielony bit NOT NULL,
    czy_otwarte_boiska bit NOT NULL,
    czy_sklepik_szkolny bit NOT NULL,
    czy_bufet_stolowka bit NOT NULL,
    czy_posilki_wegetarianskie bit NOT NULL,
    czy_posilki_weganskie bit NOT NULL,
    czy_zrodlo_wody_pitnej bit NOT NULL,
    czy_monitoring bit NOT NULL,
    czy_wejscie_na_karty bit NOT NULL,
    czy_rejestracja_gosci bit NOT NULL,
    czy_rzecznik_praw_ucznia bit NOT NULL,
    czy_pielegniarka bit NOT NULL,
    czy_psycholog_na_etacie bit NOT NULL,
    czy_pedagog_specjalny bit NOT NULL,
    czy_osoba_zaufania bit NOT NULL,
    czy_zajecia_tus bit NOT NULL,
    czy_rewalidacja bit NOT NULL,
    czy_winda bit NOT NULL,
    czy_podjazd_dla_wozkow bit NOT NULL,
    czy_petla_indukcyjna bit NOT NULL,
    czy_schodolaz bit NOT NULL,
...
ALTER TABLE dbo.Mostek_Szkola_Inicjatywy ADD CONSTRAINT FK_Mostek_Szkola
    FOREIGN KEY (id_szkoly_rspo) REFERENCES dbo.Wymiar_Szkola (id_szkoly_rspo);

ALTER TABLE dbo.Mostek_Szkola_Inicjatywy ADD CONSTRAINT FK_Mostek_Inicjatywa
    FOREIGN KEY (id_inicjatywy) REFERENCES dbo.Wymiar_Inicjatywy_Zewnetrzne (id_inicjatywy);

ALTER TABLE dbo.Fakt_Ranking_Perspektywy ADD CONSTRAINT FK_Ranking_Czas
    FOREIGN KEY (id_czas) REFERENCES dbo.Wymiar_Czas (id_czas);

ALTER TABLE dbo.Fakt_Ranking_Perspektywy ADD CONSTRAINT FK_Ranking_Szkola
    FOREIGN KEY (id_szkoly_rspo) REFERENCES dbo.Wymiar_Szkola (id_szkoly_rspo);

ALTER TABLE dbo.Fakt_Rekrutacja_Wyniki ADD CONSTRAINT FK_Rekrutacja_Profil
    FOREIGN KEY (id_profilu) REFERENCES dbo.Wymiar_Profil (id_profilu);

ALTER TABLE dbo.Fakt_Rekrutacja_Wyniki ADD CONSTRAINT FK_Rekrutacja_Atmosfera
    FOREIGN KEY (id_atmosfera) REFERENCES dbo.Wymiar_Atmosfera (id_atmosfera);

ALTER TABLE dbo.Fakt_Rekrutacja_Wyniki ADD CONSTRAINT FK_Rekrutacja_Czas
    FOREIGN KEY (id_czas) REFERENCES dbo.Wymiar_Czas (id_czas);

ALTER TABLE dbo.Fakt_Rekrutacja_Wyniki ADD CONSTRAINT FK_Rekrutacja_Szkola
    FOREIGN KEY (id_szkoly_rspo) REFERENCES dbo.Wymiar_Szkola (id_szkoly_rspo);

ALTER TABLE dbo.Fakt_Matura_Statystyki_Szczegolowe ADD CONSTRAINT FK_Szczegoly_Szkola
    FOREIGN KEY (id_szkoly_rspo) REFERENCES dbo.Wymiar_Szkola (id_szkoly_rspo);

ALTER TABLE dbo.Fakt_Matura_Statystyki_Szczegolowe ADD CONSTRAINT FK_Szczegoly_Czas
    FOREIGN KEY (id_czas) REFERENCES dbo.Wymiar_Czas (id_czas);

ALTER TABLE dbo.Fakt_Matura_Statystyki_Szczegolowe ADD CONSTRAINT FK_Szczegoly_Przedmiot
    FOREIGN KEY (id_przedmiotu) REFERENCES dbo.Wymiar_Przedmiot_Maturalny (id_przedmiotu);

ALTER TABLE dbo.Fakt_Matura_EWD ADD CONSTRAINT FK_EWD_Szkola_Relacja
    FOREIGN KEY (id_szkoly_rspo) REFERENCES dbo.Wymiar_Szkola (id_szkoly_rspo);

ALTER TABLE dbo.Fakt_Matura_EWD ADD CONSTRAINT FK_EWD_Czas_Relacja
    FOREIGN KEY (id_czas) REFERENCES dbo.Wymiar_Czas (id_czas);

ALTER TABLE dbo.Fakt_Matura_EWD ADD CONSTRAINT FK_EWD_Typ_Relacja
    FOREIGN KEY (id_typu_ewd) REFERENCES dbo.Wymiar_Typ_EWD (id_typu_ewd);